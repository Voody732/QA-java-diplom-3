...
public class LoginTest {
    ...
    @Test
    @DisplayName("Авторизация через нажатие кнопки Личный кабинет")
    ...
    @Test
    @DisplayName("Авторизация через нажатие кнопки Войти в аккаунт")
    @Description("Успешная авторизация, автоматический переход на стартовую страницу," +
            "кнопка Войти в аккаунт поменялась на Оформить заказ")
    ...
    @Test
    @DisplayName("Авторизация через нажатие кнопки Войти на странице Регистрации, " +
    ...
    @Test
    @DisplayName("Авторизация через нажатие кнопки Войти на странице Восстановления пароля, " +
